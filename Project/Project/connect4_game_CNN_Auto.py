...
- Run CNN-based Connect Four Experiments against a random generator
'''
...
if __name__ == "__main__":
    ...
    print("******** CNN-based Connect 4 Game Experiments ********")
        ...
        for count in range(total_plays):
            ...
            while True:
                ...
                if b.check_win() != None:
                    ...
                    AI_wins += 1
                    break
                print('Random Generator makes move')
                col = random.randint(1,7)-1
                b.player_make_move('1' , col)
                for i in b.return_board():
                    print(i)
                if b.check_win() != None:
                    print('Random Generator Wins!')
                    P1_wins += 1
                    break
                board_copy = []
                for i in b.return_board():
