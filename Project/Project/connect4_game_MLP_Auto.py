...
- Run MLP-based Connect Four Experiments against a random generator
'''
...
class Connect4:
    ...
    def ai_make_move(self, B):
        ...
        for col in range(self.width):
            ...
            scores.append(clf_MLP.predict_proba([b_flat])[0][0])
...
if __name__ == "__main__":
    ...
    print("******** MLP-based Connect 4 Game Experiments ********")
    ...
    for count in range(total_experiments):
        ...
        for count in range(total_plays):
            ...
            clf_MLP = pickle.load(open("Weights/MLP_Connect4_Unbalanced.sav", 'rb'))
